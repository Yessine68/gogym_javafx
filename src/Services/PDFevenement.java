...
public class PDFevenement {
    public void liste_SallePDF(String filename) throws FileNotFoundException, DocumentException, BadElementException, IOException {
        ...
        Image img2 = Image.getInstance("C:\\Users\\MSI\\Documents\\NetBeansProjects\\Pidev desktop\\src\\images\\gogymlogo-removebg-preview.png");
       ...
       for (i = 0; i < evenements.size(); i++) {
            ...
            Image img23 = Image.getInstance("C:\\Users\\MSI\\Documents\\NetBeansProjects\\Pidev desktop\\src\\uploads\\"+evenements.get(i).getImage());
